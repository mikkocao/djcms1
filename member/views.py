...
def send_email(email, code):
    ...
    subject, from_email, to = '来自www.robindongblog.com的测试邮件', 'mizuno@163.com', email
    ...
    if request.method == "POST":
        ...
        if register_form.is_valid():  # 获取数据
            ...
            if password1 != password2:  # 判断两次密码是否相同
                ...
                return render(request, 'member/confirm.html', locals())  # 跳转到等待邮件确认页面。
...
def user_confirm(request):
    ...
    try:
        ...
        message = '无效的确认请求!'
        return render(request, 'member/confirm.html', locals())
